...
for i in $(seq 1 3); do curl "https://codex.flywire.ai/app/cell_details?root_id=720575940638460998&smoke_test=$SMOKE_TEST_PROD_KEY" | grep "Class" || echo -e "\033[1;31m FAILED\nFAILED\nFAILED\nFAILED\nFAILED\nFAILED\nFAILED\nFAILED  \033[0m"; done && \
