...
from local_data_loader import DATA_ROOT_PATH, available_data_versions, unpickle_all_neuron_db_versions, \
...
class NeuronDataTest(TestCase):
    ...
    def test_annotations(self):
        ...
        self.assertEqual(self.neuron_db.closest_token('BLOBE', case_sensitive=True), 'LIKE')
